...
public class AlignToPoseCommand extends Command {
    ...
    public AlignToPoseCommand(SwerveSubsystem drive, Supplier<Pose2d> target) {
        this.drive = drive;
        this.target = target;
    ...
    public AlignToPoseCommand(SwerveSubsystem drive, Supplier<Pose2d> target, Supplier<Pose2d> robot) {
        this(drive, target);
        this.robot = robot;
    }
